    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/40 p-4">
      <Card className="w-full max-w-md shadow-lg border-2 border-primary/5">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-3xl font-bold tracking-tight">CRM Papiatech</CardTitle>
          <CardDescription className="text-muted-foreground text-base">
            Bienvenido de nuevo. Accede a tu panel administrativo.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 mt-2">
          ...
          <Button 
            ...
            className="w-full h-12 text-base font-semibold shadow-sm hover:bg-neutral-50 transition-all duration-200 gap-3"
          >
            {loading ? (
