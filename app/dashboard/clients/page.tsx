...
import { ClientTable } from "@/components/clients/ClientList";
        ...
        <div className="h-full flex flex-col overflow-hidden">
            <div className="flex justify-between items-end pb-4 border-b border-slate-200/50 mb-4 shrink-0 px-1">
                <div>
                    ...
                    <p className="text-slate-500 font-medium tracking-tight">Track your leads and manage client treatments efficiently.</p>
                </div>
                <Button
